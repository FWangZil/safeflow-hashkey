/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: e366e7e5a66026e30893bfdb3f8b0f93)
// Runtime types generated with workerd@1.20260410.1 2024-12-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AUDIT_KV: KVNamespace;
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* safeflow-web */;
	}
}
